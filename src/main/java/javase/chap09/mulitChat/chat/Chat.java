...
public class Chat extends JFrame{
    ...
    public void setVisible(boolean b) {
        ...
        tipText.setPreferredSize(new Dimension(windowWidth - 10, 20));
...
*/
       ...
       // centerPanel.add(usersPanel, BorderLayout.WEST);
        ...
        inputText.setPreferredSize(new Dimension(windowWidth - 100, 100));
        bottonPanel.add(inputText, BorderLayout.WEST);
        //设置发送按钮和清空按钮
        bottonPanel.add(sendButton, BorderLayout.EAST);
        //bottonPanel.add(clearButton, BorderLayout.SOUTH);
